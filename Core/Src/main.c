...
int main(void) {
	...
	HAL_PWR_DisableWakeUpPin(PWR_FLAG_WKUP1);
	HAL_PWR_DisableWakeUpPin(PWR_FLAG_WKUP2);
	HAL_PWR_DisableWakeUpPin(PWR_FLAG_WKUP3);
	HAL_PWR_DisableWakeUpPin(PWR_FLAG_WKUP4);
	HAL_PWR_DisableWakeUpPin(PWR_FLAG_WKUP5);
	HAL_PWR_DisableWakeUpPin(PWR_FLAG_WKUP6);
